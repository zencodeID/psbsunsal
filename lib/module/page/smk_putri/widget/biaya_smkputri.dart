...
import 'package:psbsunsal/module/page/smk_putri/widget/util/rincian_biaya.dart';

class BiayaSMKPutri extends StatelessWidget {
  const BiayaSMKPutri({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    RincianBiayaSMK(rincian: "SPP ", nominal: " 3.500.000"),
                    Divider(
                      color: Colors.grey,
                      thickness: 1,
                    ),
