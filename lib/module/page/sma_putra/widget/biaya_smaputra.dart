...
import 'package:psbsunsal/module/page/sma_putra/widget/util/rincian_biaya.dart';

class BiayaSMAPutra extends StatelessWidget {
  const BiayaSMAPutra({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    RincianBiayaSMA(rincian: "SPP ", nominal: " 3.500.000"),
                    Divider(
                      color: Colors.grey,
                      thickness: 1,
                    ),
